"""
Print the last two elements of the list below
...
"""
Use a single statement to repeat the elements of the list three times 
...
"""
Use a single statement to concatenate two lists  
...
"""
Use a single statement to extract a portion of a list  
and store the result in a new list. Print the new list.  
...
"""
Create an empty list and use the append() method to add elements to it.  
...
"""
Use a for loop to create a deep copy of a list and store the result in a new list.  
Start with an empty list, then copy each element from the original list into the new list.  
